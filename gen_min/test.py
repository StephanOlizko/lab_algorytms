...
class GeneticAlgorithmGUI:
    ...
    def create_widgets(self):
        ...
        ttk.Label(parameter_frame, text="Количество поколений:").grid(row=1, column=0, sticky="w")
        generations_entry = ttk.Entry(parameter_frame, textvariable=self.generations_var)
        generations_entry.grid(row=1, column=1, sticky="w")
